...
CompoundCases =
    'ヲメグッテ ヲツウジテ ヲフクメテ ニカランデ ニソッテ ニムケテ ニトモナッテ ニカンシテ ニモトヅイテ ヲノゾイテ ニヨッテ ニタイシテ ニカワッテ ニオイテ ニツイテ ニトッテ ニクワエテ ニカギッテ ニツヅイテ ニアワセテ ニクラベテ ニナランデ トシテ ニヨラズ ニカギラズ ニシテ'.split(
        ' ',
    );
...
ColorNE = '#F7E1BB';
STRONG_SUFFIX =
    /^(?:率|通り|どおり|方|がた|かた|型|形|用|製|家|者|数|費|入り|いり|あけ|上|じょう|作り|づくり|ずみ|無し|なし|増|減|的だ|化|さ|都|道|府|県|郡|市|村|町|区|州)$/;
